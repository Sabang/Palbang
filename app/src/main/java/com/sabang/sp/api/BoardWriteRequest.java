...
public class BoardWriteRequest extends BaseRequest<BaseModel>{
    ...
    public static BoardWriteRequest newInstance(String user,String title, String content, String cost, String item,  Response.Listener<BaseModel> listener, Response.ErrorListener errorListener){
